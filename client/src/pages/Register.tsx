            ...
            <div className='bg-white min-h-full flex justify-center flex-col items-center relative p-5'>
                <form onSubmit={handleSubmit} className="w-full md:w-1/2 lg:w-2/3">
                    ...
                    <div className="text-center lg:hidden">
                        ...
                        <button className="flex lg:hidden w-full my-3 items-center justify-center p-3 rounded-full border border-lightGray/40 text-lg gap-2"><FcGoogle size={30}/>Sign up with Google</button>
                        <span className="text-base flex lg:hidden justify-center">or</span>
                    </div>
                    <div className="flex flex-col items-start justify-start py-1 relative">
                        ...
                        <input 
                            type="text" 
                            autoFocus 
                            className="required border-b border-lightGray/80 outline-none text-xl w-full pl-7 p-2" 
                            placeholder="Kennytech"
                            name="username"
                            value={username}
                            onChange={handleChange} 
                            required
                        />
                        <span className="absolute left-0 bottom-5 text-darkGray"><FaRegUser size={20}/></span>
                    </div>
                    <div className="flex flex-col items-start justify-start py-1 relative">
                    ...
                    <div className="flex flex-col items-start justify-start py-1 relative">
                        ...
                        <input 
                            ...
                            className=" border-b border-lightGray/80 outline-none text-xl w-full pl-7 p-2" 
                            placeholder="**********"
                            name="password"
                            value={password}
                            onChange={handleChange}
                    ...
                    <div className="flex flex-col items-start justify-start py-1 relative">
                        <label htmlFor="password" className="text-base md:text-lg">Confirm Password</label>
                        <input 
                    ...
                    <p className="gap-2 flex py-1 items-center"><input type="checkbox" required name="" id="" className="cursor-pointer" />I accept the Terms of Use.</p>
                    ...
                    <button className="hidden lg:flex w-full my-3 items-center justify-center p-3 rounded-full border border-lightGray/40 text-lg gap-2"><FcGoogle size={30}/>Sign up with Google</button>
                    <span className="pl-4 my-3 block py-3">Already have an account?<Link to={'/login'} className="text-blue1 px-2 hover:underline decoration-2 underline-offset-2">login</Link></span>
                </form>
            </div>
        </div>
    </div>
