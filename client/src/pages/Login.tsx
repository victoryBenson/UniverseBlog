            ...
            <div className='bg-white min-h-full flex justify-center flex-col items-center relative p-5'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col items-start justify-start py-2 relative">
                        ...
                        <input type="email" value={formState.email} name="email" required onChange={handleChange} autoFocus className="required  border-b border-lightGray/80 outline-none text-xl w-full md:w-[30vw] pl-7 p-2 font-light" placeholder="example@gmail.com" />
                    ...
                    <div className="flex flex-col items-start justify-start py-3 relative">
                        ...
                        <input type={viewPwd? "text" : "password"} name="password" required value={formState.password} onChange={handleChange} className=" border-b border-lightGray/80 outline-none text-xl w-full md:w-[30vw] pl-7 p-2" placeholder="**********" />
